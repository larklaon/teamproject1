"""
경로 탐색 알고리즘 프로젝트 - 상세 주석 버전
============================================

이 파일은 코딩을 처음 배우는 사람도 이해할 수 있도록 
매우 자세한 주석을 포함한 경로 탐색 시스템입니다.
...
class PathfindingSystem:
    ...
    def __init__(self):
        ...
        # 4. 격자 크기 설정
        # ============================================
        self.grid_size = (50, 50)  # 기본 격자 크기: 가로 50, 세로 50
        self.grid = None           # 실제 격자 데이터 (나중에 생성됨)
    ...
    def create_grid(self, data):
        ...
        max_x = max(data['x'].max(), self.grid_size[0])  # 가로 크기
        max_y = max(data['y'].max(), self.grid_size[1])  # 세로 크기
